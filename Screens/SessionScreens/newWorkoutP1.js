...
export default function newWorkoutP1() {
    ...
    return (
        <SafeAreaView style={styles.container}>
           ...
           <TouchableOpacity  onPress={() =>navigation.navigate("NewWorkoutP2")}>
            <Button icon="folder-multiple-plus" text="Vorhandenes Workout auswählen"/>
           </TouchableOpacity>
...
const Button = ({icon,text}) =>{
    ...
    return (<View style={{borderWidth:1,borderColor:"white",borderRadius:30,height:200,alignItems:"center",justifyContent:"center",marginVertical:20,}}>
