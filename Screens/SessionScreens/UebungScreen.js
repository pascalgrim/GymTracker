...
import { View ,StyleSheet,TouchableOpacity, Image, KeyboardAvoidingView} from "react-native";
...
export default function UebungScreen() {
    ...
    <View style={styles.container}>
      <View style={styles.mainContent}>
        <View style={styles.header}>
          <View style={{ flex: 2 }}>
            <MyText bold text="Bankdrücken" fontSize={35} />
            <MyText text="Langhantel" color="grey"/>
          </View>
        </View>
        <View style={{backgroundColor:Colors.offColor,borderRadius:10,paddingRight:20,paddingLeft:20,paddingTop:10,paddingBottom:40}}>
          ...
          <View style={{flexDirection:"row",justifyContent:"space-evenly",paddingTop:30,}}>
            ...
            <Image source={wdhIcon} style={{height:30,width:30,marginBottom:10}}/>
            <NumericInput 
              value={wdh} 
            ...
            <View style={{alignItems:"center"}}>
            <Image source={gewichtIcon} style={{height:30,width:30,marginBottom:10}}/>
            <NumericInput 
              value={gewicht} 
        ...
        <View style={{backgroundColor:"white",flexDirection:"row",justifyContent:"space-between",alignItems:"center",paddingLeft:10,paddingRight:10,height:50,marginTop:50}}>
        ...
        <IconButton color="black" icon="check" size={40} theme={myTheme} style={{backgroundColor:"lightgreen",position:"absolute",right:0}}/>
        </KeyboardAvoidingView>
